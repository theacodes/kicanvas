...
export default function layers() {
    const layers_ordered = [
        ...
        new Layer(1, "Virtual:Via:Holes", "Virtual:Vias"),
        new Layer(1, "Virtual:Pad:PlatedHoles", "Virtual:Pads"),
        new Layer(1, "Virtual:NonPlatedHoles", "Virtual:Pads"),
        new Layer(1, "Virtual:Via:Through", "Virtual:Vias"),
        new Layer(1, "Virtual:Via:BuriedBlind", "Virtual:Vias"),
        new Layer(1, "Virtual:Via:MicroVia", "Virtual:Vias"),
        new Layer(1, "Virtual:Pad:Through", "Virtual:Pads"),
