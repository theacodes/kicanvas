...
export default function layers() {
    const layers_ordered = [
        ...
        new Layer(1, "Virtual:Via:Holewalls", "Virtual:Vias"),
        new Layer(1, "Virtual:Pad:PlatedHoles", "Virtual:Pads"),
        new Layer(1, "Virtual:Pad:Holewalls", "Virtual:Pads"),
        ...
        new Layer(1, "Virtual:B.Cu:Zones"),
        new Layer(1, "Board:B.Mask"),
        new Layer(1, "Virtual:B.Mask.Zones"),
        new Layer(1, "Board:B.SilkS"),
        new Layer(1, "Virtual:B.SilkS.Zones"),
        new Layer(1, "Board:B.Adhes"),
        new Layer(1, "Virtual:B.Adhes:Zones"),
        new Layer(1, "Board:B.CrtYd"),
        new Layer(1, "Virtual:B.Cu:Zones"),
        new Layer(1, "Board:B.Fab"),
        new Layer(1, "Virtual:B.Fab:Zones"),
    ];
